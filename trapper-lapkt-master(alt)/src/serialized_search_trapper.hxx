...
public:
    ...
    Serialized_Search( 	const Search_Model& search_problem, PartialStateCollection* psc ) 
	: Search_Strategy( search_problem, psc ), m_consistency_test(true), m_closed_goal_states( NULL )  {	   
