...
public:
	...
	RP_IW( 	const Search_Model& search_problem, PartialStateCollection* psc ) 
		: m_problem( search_problem ), m_exp_count(0), m_gen_count(0), m_cl_count(0), m_max_depth(0), m_pruned_B_count(0), m_B( infty ), m_use_relplan(true), m_goals(NULL), m_verbose(true), m_psc_traps(psc), m_h2_traps_count(0), m_psc_traps_count(0), m_reachable_traps_count(0) {	   
