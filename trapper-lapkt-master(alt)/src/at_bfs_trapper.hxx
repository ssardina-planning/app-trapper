...
public:
	...
	AT_BFS_SQ_SH( 	const Search_Model& search_problem, PartialStateCollection* psc ) 
	...
	m_exp_count(0), m_gen_count(0), m_pruned_B_count(0), m_dead_end_count(0), m_open_repl_count(0),
	  m_B( infty ), m_time_budget(infty), m_greedy(false), m_delay_eval(false), m_psc_traps(psc), m_h2_traps_count(0), m_psc_traps_count(0), m_reachable_traps_count(0) {
